#!/usr/bin/env python3
"""
Fixed version of advanced data analyzer with all map object errors resolved.
"""
...
class FixedHybridDataAnalyzer:
    ...
    def run_all_analyses(self) -> List[Dict]:
        ...
        print("🔍 Running 10 Fixed Advanced Analyses on Hybrid Export Data...")
        print("=" * 60)
...
"""
    ...
    # Helper methods (same as original but with fixed implementations)
  ...
  • Stwórz shared context dla wspólnych danych"""
    ...
    def generate_summary_report(self):
        ...
        print(f"\n📊 FIXED SUMMARY REPORT - {len(self.analysis_results)} Analyses")
        print("=" * 60)
        ...
        print(f"\n💾 Saved {len(self.analysis_results)} LLM queries to 'fixed_llm_refactoring_queries.yaml'")
    ...
    def _save_llm_queries(self):
        ...
        output_path = self.hybrid_path / 'fixed_llm_refactoring_queries.yaml'
...
def main():
    ...
    analyzer = FixedHybridDataAnalyzer(hybrid_path)
