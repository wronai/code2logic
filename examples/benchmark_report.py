...
def main() -> None:
    ...
    artifacts: List[Artifact] = [
        ...
        Artifact(
            ...
            out_dir / "project.functions.toon",
            "Function-logic (TOON; generated with --function-logic --with-schema --compact --no-repeat-module)",
        ),
        Artifact("Schema: TOON", out_dir / "project.toon-schema.json", "JSON Schema for project.toon"),
        Artifact("Schema: function-logic", out_dir / "project.functions-schema.json", "JSON Schema for project.functions.toon"),
